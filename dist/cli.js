    ...
    agents: [
      {
        ...
        description: "Orquestador con recuperación automática (nunca se congela), ruteo por nivel de impacto, controller MCP con SDK oficial, edición segura con fallback inline, y delegación en OpenSpec + Superpowers. v0.8.7: prune de skills obsoletas, lastHandoff, getAvailableTransitions, consecutiveFailures real, mem_session_summary automático al cierre.",
        version: "0.8.7",
    ...
    commands: [
      {
        ...
        description: "Instala el stack tecnológico del proyecto (CodeGraph, skills, OpenSpec, Engram, controller plugin). v0.8.7: controller plugin como alma hard-gate, Context7 removido del stack.",
        version: "0.8.7",
    ...
    mcpServers: [
      {
        ...
        description: "Máquina de estados persistida con @modelcontextprotocol/server SDK. v0.8.7: 22 tools (incluye set_handoff, get_handoff, clear_handoff, get_available_transitions funcional). Bugfixes: consecutiveFailures real, lastHandoff state, defaultChoice persistido. Robustez: degraded mode automático tras 3 fallos, persistence condicional para Nivel 0, prune de skills obsoletas.",
        version: "0.8.7",
        sha256: "b311b2e038b9054c78e61dc71ea4c42f79281d621a536b88b828d4b38134b038"
      },
      {
        name: "openspec",
...
`);
      ...
      send({
        ...
        params: {
          ...
          capabilities: {},
          clientInfo: { name: "ostacky-installer", version: "0.8.7" }
        }
      });
    });
  } finally {
