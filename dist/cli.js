        ...
        agents: [
            {
                ...
                description:
                    'Orquestador con recuperación automática (nunca se congela), ruteo por nivel de impacto, controller MCP con SDK oficial, edición segura con fallback inline, y delegación en OpenSpec + Superpowers. v0.8.5: prune de skills obsoletas, lastHandoff, getAvailableTransitions, consecutiveFailures real, mem_session_summary automático al cierre.',
                version: '0.8.5',
        ...
        commands: [
            {
                ...
                description:
                    'Instala el stack tecnológico del proyecto (CodeGraph, skills, OpenSpec, Engram, controller plugin). v0.8.5: controller plugin como alma hard-gate, Context7 removido del stack.',
                version: '0.8.5',
...
var package_default = {
    ...
    scripts: {
        ...
        prepublishOnly: 'bun run manifest:prepare && bun run build',
    },
...
`
            ...
            send({
                ...
                params: {
                    ...
                    capabilities: {},
                    clientInfo: { name: 'ostacky-installer', version: '0.8.5' },
                },
            });
        });
    } finally {
