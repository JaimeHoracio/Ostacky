  ...
  manifest_default = {
    ...
    agents: [
      {
        ...
        description: "Orquestador con recuperación automática (nunca se congela), ruteo por nivel de impacto, controller MCP con SDK oficial, edición segura con fallback inline, y delegación en OpenSpec + Superpowers. v0.8.6: prune de skills obsoletas, lastHandoff, getAvailableTransitions, consecutiveFailures real, mem_session_summary automático al cierre.",
        version: "0.8.6",
        sha256: "51bb5f57b493791c27e8134c3eb4e8bfb61a7672c40bf648c79f15c7ec2f6319"
      }
    ],
    commands: [
      {
        ...
        description: "Instala el stack tecnológico del proyecto (CodeGraph, skills, OpenSpec, Engram, controller plugin). v0.8.6: controller plugin como alma hard-gate, Context7 removido del stack.",
        version: "0.8.6",
        sha256: "52f7af2a59fb3db19c33dccde7b284afdb3270e68696c721ad3303dcc85a645c"
      },
      {
        name: "opsx-sync",
    ...
    mcpServers: [
      {
        ...
        description: "Máquina de estados persistida con @modelcontextprotocol/server SDK. v0.8.6: 22 tools (incluye set_handoff, get_handoff, clear_handoff, get_available_transitions funcional). Bugfixes: consecutiveFailures real, lastHandoff state, defaultChoice persistido. Robustez: degraded mode automático tras 3 fallos, persistence condicional para Nivel 0, prune de skills obsoletas.",
        version: "0.8.6",
        sha256: "8f3beed194072517b2c47dfca10f9496613e241f16acf8d2413d64118451bf70"
      },
      {
        name: "openspec",
    ...
    skills: [
      ...
      },
      {
        ...
        version: "0.8.6",
        sha256: "7a670f8ae9d5479840d9fc4a54fa6ae75809b2c8883414d39300fa6289b82e9a"
      },
      {
        name: "tdd",
...
`);
      ...
      send({
        ...
        params: {
          ...
          capabilities: {},
          clientInfo: { name: "ostacky-installer", version: "0.8.6" }
        }
      });
    });
  } finally {
