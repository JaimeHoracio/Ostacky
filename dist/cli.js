        ...
        agents: [
            {
                ...
                description:
                    'Orquestador con recuperación automática (nunca se congela), ruteo por nivel de impacto, controller MCP con SDK oficial, edición segura con fallback inline, y delegación en OpenSpec + Superpowers. v0.8.9: prune de skills obsoletas, lastHandoff, getAvailableTransitions, consecutiveFailures real, mem_session_summary automático al cierre.',
                version: '0.8.9',
                sha256: 'bac9b7bc91d9d958bee8c6b2e094b1e1124bcc7f3e23cd13769ebbc5766f4747',
            },
        ],
        commands: [
            {
                ...
                description:
                    'Instala el stack tecnológico del proyecto (CodeGraph, skills, OpenSpec, Engram, controller plugin). v0.8.9: controller plugin como alma hard-gate, Context7 removido del stack.',
                version: '0.8.9',
                sha256: '28ddf7ac8a2472faa1a5dbd14e22bc11e0b8715971907b3fab739b9933aa7dad',
            },
            {
                name: 'opsx-sync',
...
`
            ...
            send({
                ...
                params: {
                    ...
                    capabilities: {},
                    clientInfo: { name: 'ostacky-installer', version: '0.8.9' },
                },
            });
        });
    } finally {
...
async function runDoctorCommand() {
    ...
    for (const t of tools) {
        ...
        const pExe = p + '.exe';
        check(
            `tool ${t}: ${existsSync8(p) || existsSync8(pExe) ? 'found' : 'missing'}`,
            existsSync8(p) || existsSync8(pExe),
            true
        );
    }
    try {
    ...
    try {
        ...
        if (coreSync) {
            ...
            const ok =
                readFileSync6(coreMcp, 'utf-8').includes('STATES') &&
                readFileSync6(corePlugin, 'utf-8').includes('STATES');
        ...
        if (existsSync8(auditPath)) {
            ...
            const lines = readFileSync6(auditPath, 'utf-8')
                .split(
                    `
`
                )
