...
```json
{
    ...
    "skills": {
        "brainstorming": { "version": "0.8.6", ... },
        "execution-mode-evaluation": { "version": "0.8.6", ... },
        "openspec-propose": { "version": "0.8.6", ... }
    },
    "mcpServers": {
        "ostacky-controller": { "version": "0.8.6", ... },
        "openspec": { "version": "0.8.6", ... }
    }
}
```
...
- Las URLs de descarga usan **tags de GitHub** (ej. `v0.8.6`), nunca `main` — instalaciones reproducibles
