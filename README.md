...
```json
{
    ...
    "skills": {
        "brainstorming": { "version": "0.8.9", ... },
        "execution-mode-evaluation": { "version": "0.8.9", ... },
        "openspec-propose": { "version": "0.8.9", ... }
    },
    "mcpServers": {
        "ostacky-controller": { "version": "0.8.9", ... },
        "openspec": { "version": "0.8.9", ... }
    }
}
```
...
- Las URLs de descarga usan **tags de GitHub** (ej. `v0.8.9`), nunca `main` — instalaciones reproducibles
