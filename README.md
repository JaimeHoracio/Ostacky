...
```json
{
    ...
    "skills": {
        "brainstorming": { "version": "0.8.3", ... },
        "execution-mode-evaluation": { "version": "0.8.3", ... },
        "openspec-propose": { "version": "0.8.3", ... }
    },
    "mcpServers": {
        "ostacky-controller": { "version": "0.8.3", ... },
        "openspec": { "version": "0.8.3", ... }
    }
}
```
...
- Las URLs de descarga usan **tags de GitHub** (ej. `v0.8.3`), nunca `main` — instalaciones reproducibles
