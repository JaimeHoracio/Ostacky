...
```json
{
    ...
    "skills": {
        "brainstorming": { "version": "0.5.2", ... },
        "execution-mode-evaluation": { "version": "0.5.2", ... },
        "openspec-propose": { "version": "0.5.2", ... }
    }
}
```
...
- Las URLs de descarga usan **tags de GitHub** (ej. `v0.5.2`), nunca `main` — instalaciones reproducibles
