...
digraph process {
    ...
    "Use review" [shape=box style=filled fillcolor=lightgreen];
    ...
    "Dispatch final code reviewer subagent for entire implementation" -> "Use review";
}
```
...
- Inline execution via the orchestrator when tasks are tightly coupled
